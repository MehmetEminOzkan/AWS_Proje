...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.cpqmwuk0c375.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-emin-blog' # please enter your s3 bucket name
